...
public class Kajamenu : MonoBehaviour
{
    ...
    private void OnEnable()
    {
        ...
        mainindex = PlayerPrefs.GetInt("Kajamainweaponindex");
        secondindex = PlayerPrefs.GetInt("Kajasecondweaponindex");
        ...
        hpanzeige.text = "HP " + Statics.charcurrenthealth[2] + "/" + Statics.charmaxhealth[2];
    }
    ...
    public void choosemainweapon(int mariaweapon)
    {
        ...
        {
            PlayerPrefs.SetInt("Kajamainweaponindex", mainindex);
            Mainslot.gameObject.GetComponent<Image>().sprite = images[mainindex];
            oldmainindex = mainindex;
            waffenmenu.SetActive(false);
            waffenmenu2.SetActive(false);
    ...
    public void choosesecondweapon(int kajasecondweapon)
    {
        secondindex = kajasecondweapon;
        ...
        {
            PlayerPrefs.SetInt("Kajasecondweaponindex", secondindex);
            Seclondslot.gameObject.GetComponent<Image>().sprite = images[secondindex];
            oldsecondindex = secondindex;
            waffenmenu.SetActive(false);
            waffenmenu2.SetActive(false);
