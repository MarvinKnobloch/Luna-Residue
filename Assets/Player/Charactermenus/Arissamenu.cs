...
public class Arissamenu : MonoBehaviour
{
    ...
    private void OnEnable()
    {
        ...
        mainindex = PlayerPrefs.GetInt("Arissamainweaponindex");
        secondindex = PlayerPrefs.GetInt("Arissasecondweaponindex");
        ...
        hpanzeige.text = "HP " + Statics.charcurrenthealth[4] + "/" + Statics.charmaxhealth[4];
    }
    ...
    public void choosemainweapon(int mariaweapon)
    {
        ...
        {
            PlayerPrefs.SetInt("Arissamainweaponindex", mainindex);
            Mainslot.gameObject.GetComponent<Image>().sprite = images[mainindex];
            oldmainindex = mainindex;
            waffenmenu.SetActive(false);
            waffenmenu2.SetActive(false);
    ...
    public void choosesecondweapon(int arissasecondweapon)
    {
        secondindex = arissasecondweapon;
        ...
        {
            PlayerPrefs.SetInt("Arissasecondweaponindex", secondindex);
            Seclondslot.gameObject.GetComponent<Image>().sprite = images[secondindex];
            oldsecondindex = secondindex;
            waffenmenu.SetActive(false);
            waffenmenu2.SetActive(false);
