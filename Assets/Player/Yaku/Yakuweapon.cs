...
public class Yakuweapon : MonoBehaviour
{
    ...
    {
        mainweaponindex = PlayerPrefs.GetInt("Yakumainweaponindex");
        secondweaponindex = PlayerPrefs.GetInt("Yakusecondweaponindex");
    ...
    {
        Statics.weaponswitchbuff = 1 * Statics.charweaponbuff[charnumber];
    }
}
