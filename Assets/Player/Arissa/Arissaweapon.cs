...
public class Arissaweapon : MonoBehaviour
{
    ...
    {
        mainweaponindex = PlayerPrefs.GetInt("Arissamainweaponindex");
        secondweaponindex = PlayerPrefs.GetInt("Arissasecondweaponindex");
