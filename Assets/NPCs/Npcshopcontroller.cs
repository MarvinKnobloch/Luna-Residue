...
public class Npcshopcontroller : MonoBehaviour
{
    ...
    private Itemtype[] itemtypes = { Itemtype.Sword, Itemtype.Bow, Itemtype.Fist, Itemtype.Head, Itemtype.Chest, Itemtype.Belt, Itemtype.Legs, Itemtype.Shoes, Itemtype.Neckless, Itemtype.Ring };
