...
public class Arissanpcweapon : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        if (PlayerPrefs.GetInt("Arissamainweaponindex") == 1)                      // bis jetzt nur 1 weil noch keine andere rangewaffe vorhanden ist
        {
