...
public class Ninjastar : MonoBehaviour
{
    ...
    private void OnTriggerEnter(Collider other)
    {
        if(Statics.infight == true)
        {
            ...
            {
                LoadCharmanager.Overallmainchar.GetComponent<Playerhp>().takedamageignoreiframes(Globalplayercalculations.calculateenemyspezialdmg(basedmg, Statics.currentenemyspeziallvl, 3), true);
                gameObject.SetActive(false);
            }
        }
