...
public class Doozycontroller : MonoBehaviour
{
    ...
    {       
        ...
        {
            LoadCharmanager.Overallmainchar.GetComponent<Playerhp>().takedamagecheckiframes(Globalplayercalculations.calculateenemyspezialdmg(basedmg, Statics.currentenemyspeziallvl, 1) / needednumbers * dmgcount, true);
        }
        turnoff();
    }
    public void success()
