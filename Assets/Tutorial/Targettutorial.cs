...
public class Targettutorial : MonoBehaviour
{
    ...
    private void showtext()
    {
        if (textindex == 0) tutorialcontroller.tutorialtext.text = "The icon on the right side of the enemy health bar shows the current target of the enemy.";
        else if (textindex == 1) tutorialcontroller.tutorialtext.text = "The enemy type and level display of the players current target is red instead of white.";
                                                                        ...
                                                                        " to mark the target of your allies separately.";
    }
