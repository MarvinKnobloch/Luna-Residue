...
public class Elementaltutorial : MonoBehaviour
{
    ...
    private void showtext()
    {
        ...
        else if (textindex == 7) tutorialcontroller.tutorialtext.text = "Heal: Grants a heal bonus and add the ability to cast a group heal and resurrect (Check out <color=green>Tutorials</color> in the menu for more information).";
