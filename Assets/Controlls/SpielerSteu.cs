...
//     version 1.4.4
//     from Assets/SpielerSteu.inputactions
//
...
public partial class @SpielerSteu : IInputActionCollection2, IDisposable
{
    ...
    ""maps"": [
        {
            ...
            ""actions"": [
                ...
                },
                {
                    ""name"": ""G Button"",
                    ""type"": ""Button"",
                    ""id"": ""03ca6bcf-c7a0-4eec-ab75-b5a3f8c828aa"",
                    ""expectedControlType"": ""Button"",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": false
            ...
            ""bindings"": [
                ...
                {
                    ""name"": """",
                    ""id"": ""66f6d9ec-e5bb-4a9d-826e-0c45afe48702"",
                    ""path"": ""<Keyboard>/g"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
    ...
    ""controlSchemes"": []
        ...
        // Spielerboden
        m_Spielerboden = asset.FindActionMap("Spielerboden", throwIfNotFound: true);
        m_Spielerboden_Maus = m_Spielerboden.FindAction("Maus", throwIfNotFound: true);
        m_Spielerboden_Laufen = m_Spielerboden.FindAction("Laufen", throwIfNotFound: true);
        m_Spielerboden_Sprung = m_Spielerboden.FindAction("Sprung", throwIfNotFound: true);
        m_Spielerboden_Attack1 = m_Spielerboden.FindAction("Attack1", throwIfNotFound: true);
        m_Spielerboden_Attack2 = m_Spielerboden.FindAction("Attack2", throwIfNotFound: true);
        m_Spielerboden_Attack3 = m_Spielerboden.FindAction("Attack3", throwIfNotFound: true);
        m_Spielerboden_Attack4 = m_Spielerboden.FindAction("Attack4", throwIfNotFound: true);
        m_Spielerboden_Weaponchange = m_Spielerboden.FindAction("Weaponchange", throwIfNotFound: true);
        m_Spielerboden_Charchange = m_Spielerboden.FindAction("Charchange", throwIfNotFound: true);
        m_Spielerboden_Dash = m_Spielerboden.FindAction("Dash", throwIfNotFound: true);
        m_Spielerboden_AimLook = m_Spielerboden.FindAction("AimLook", throwIfNotFound: true);
        m_Spielerboden_Lockon = m_Spielerboden.FindAction("Lockon", throwIfNotFound: true);
        m_Spielerboden_Lockonchange = m_Spielerboden.FindAction("Lockonchange", throwIfNotFound: true);
        m_Spielerboden_Heal = m_Spielerboden.FindAction("Heal", throwIfNotFound: true);
        m_Spielerboden_Ability1 = m_Spielerboden.FindAction("Ability1", throwIfNotFound: true);
        m_Spielerboden_Ability2 = m_Spielerboden.FindAction("Ability2", throwIfNotFound: true);
        m_Spielerboden_Ability3 = m_Spielerboden.FindAction("Ability3", throwIfNotFound: true);
        m_Spielerboden_Ability4 = m_Spielerboden.FindAction("Ability4", throwIfNotFound: true);
        m_Spielerboden_Ability56 = m_Spielerboden.FindAction("Ability5/6", throwIfNotFound: true);
        m_Spielerboden_Spezial = m_Spielerboden.FindAction("Spezial", throwIfNotFound: true);
        m_Spielerboden_GButton = m_Spielerboden.FindAction("G Button", throwIfNotFound: true);
        m_Spielerboden_Interaction = m_Spielerboden.FindAction("Interaction", throwIfNotFound: true);
        m_Spielerboden_Openelemenu = m_Spielerboden.FindAction("Openelemenu", throwIfNotFound: true);
        m_Spielerboden_Openequipentmenu = m_Spielerboden.FindAction("Openequipentmenu", throwIfNotFound: true);
        m_Spielerboden_Test = m_Spielerboden.FindAction("Test", throwIfNotFound: true);
        // Menusteuerung
    ...
    // Spielerboden
    private readonly InputActionMap m_Spielerboden;
    private ISpielerbodenActions m_SpielerbodenActionsCallbackInterface;
    private readonly InputAction m_Spielerboden_Maus;
    private readonly InputAction m_Spielerboden_Laufen;
    private readonly InputAction m_Spielerboden_Sprung;
    private readonly InputAction m_Spielerboden_Attack1;
    private readonly InputAction m_Spielerboden_Attack2;
    private readonly InputAction m_Spielerboden_Attack3;
    private readonly InputAction m_Spielerboden_Attack4;
    private readonly InputAction m_Spielerboden_Weaponchange;
    private readonly InputAction m_Spielerboden_Charchange;
    private readonly InputAction m_Spielerboden_Dash;
    private readonly InputAction m_Spielerboden_AimLook;
    private readonly InputAction m_Spielerboden_Lockon;
    private readonly InputAction m_Spielerboden_Lockonchange;
    private readonly InputAction m_Spielerboden_Heal;
    private readonly InputAction m_Spielerboden_Ability1;
    private readonly InputAction m_Spielerboden_Ability2;
    private readonly InputAction m_Spielerboden_Ability3;
    private readonly InputAction m_Spielerboden_Ability4;
    private readonly InputAction m_Spielerboden_Ability56;
    private readonly InputAction m_Spielerboden_Spezial;
    private readonly InputAction m_Spielerboden_GButton;
    private readonly InputAction m_Spielerboden_Interaction;
    private readonly InputAction m_Spielerboden_Openelemenu;
    private readonly InputAction m_Spielerboden_Openequipentmenu;
    private readonly InputAction m_Spielerboden_Test;
    public struct SpielerbodenActions
    {
        private @SpielerSteu m_Wrapper;
        public SpielerbodenActions(@SpielerSteu wrapper) { m_Wrapper = wrapper; }
        public InputAction @Maus => m_Wrapper.m_Spielerboden_Maus;
        public InputAction @Laufen => m_Wrapper.m_Spielerboden_Laufen;
        public InputAction @Sprung => m_Wrapper.m_Spielerboden_Sprung;
        public InputAction @Attack1 => m_Wrapper.m_Spielerboden_Attack1;
        public InputAction @Attack2 => m_Wrapper.m_Spielerboden_Attack2;
        public InputAction @Attack3 => m_Wrapper.m_Spielerboden_Attack3;
        public InputAction @Attack4 => m_Wrapper.m_Spielerboden_Attack4;
        public InputAction @Weaponchange => m_Wrapper.m_Spielerboden_Weaponchange;
        public InputAction @Charchange => m_Wrapper.m_Spielerboden_Charchange;
        public InputAction @Dash => m_Wrapper.m_Spielerboden_Dash;
        public InputAction @AimLook => m_Wrapper.m_Spielerboden_AimLook;
        public InputAction @Lockon => m_Wrapper.m_Spielerboden_Lockon;
        public InputAction @Lockonchange => m_Wrapper.m_Spielerboden_Lockonchange;
        public InputAction @Heal => m_Wrapper.m_Spielerboden_Heal;
        public InputAction @Ability1 => m_Wrapper.m_Spielerboden_Ability1;
        public InputAction @Ability2 => m_Wrapper.m_Spielerboden_Ability2;
        public InputAction @Ability3 => m_Wrapper.m_Spielerboden_Ability3;
        public InputAction @Ability4 => m_Wrapper.m_Spielerboden_Ability4;
        public InputAction @Ability56 => m_Wrapper.m_Spielerboden_Ability56;
        public InputAction @Spezial => m_Wrapper.m_Spielerboden_Spezial;
        public InputAction @GButton => m_Wrapper.m_Spielerboden_GButton;
        public InputAction @Interaction => m_Wrapper.m_Spielerboden_Interaction;
        public InputAction @Openelemenu => m_Wrapper.m_Spielerboden_Openelemenu;
        public InputAction @Openequipentmenu => m_Wrapper.m_Spielerboden_Openequipentmenu;
        public InputAction @Test => m_Wrapper.m_Spielerboden_Test;
        public InputActionMap Get() { return m_Wrapper.m_Spielerboden; }
        public void Enable() { Get().Enable(); }
        public void Disable() { Get().Disable(); }
        public bool enabled => Get().enabled;
        public static implicit operator InputActionMap(SpielerbodenActions set) { return set.Get(); }
        public void SetCallbacks(ISpielerbodenActions instance)
        {
            if (m_Wrapper.m_SpielerbodenActionsCallbackInterface != null)
            {
                @Maus.started -= m_Wrapper.m_SpielerbodenActionsCallbackInterface.OnMaus;
                @Maus.performed -= m_Wrapper.m_SpielerbodenActionsCallbackInterface.OnMaus;
                @Maus.canceled -= m_Wrapper.m_SpielerbodenActionsCallbackInterface.OnMaus;
                @Laufen.started -= m_Wrapper.m_SpielerbodenActionsCallbackInterface.OnLaufen;
                @Laufen.performed -= m_Wrapper.m_SpielerbodenActionsCallbackInterface.OnLaufen;
                @Laufen.canceled -= m_Wrapper.m_SpielerbodenActionsCallbackInterface.OnLaufen;
                @Sprung.started -= m_Wrapper.m_SpielerbodenActionsCallbackInterface.OnSprung;
                @Sprung.performed -= m_Wrapper.m_SpielerbodenActionsCallbackInterface.OnSprung;
                @Sprung.canceled -= m_Wrapper.m_SpielerbodenActionsCallbackInterface.OnSprung;
                @Attack1.started -= m_Wrapper.m_SpielerbodenActionsCallbackInterface.OnAttack1;
                @Attack1.performed -= m_Wrapper.m_SpielerbodenActionsCallbackInterface.OnAttack1;
                @Attack1.canceled -= m_Wrapper.m_SpielerbodenActionsCallbackInterface.OnAttack1;
                @Attack2.started -= m_Wrapper.m_SpielerbodenActionsCallbackInterface.OnAttack2;
                @Attack2.performed -= m_Wrapper.m_SpielerbodenActionsCallbackInterface.OnAttack2;
                @Attack2.canceled -= m_Wrapper.m_SpielerbodenActionsCallbackInterface.OnAttack2;
                @Attack3.started -= m_Wrapper.m_SpielerbodenActionsCallbackInterface.OnAttack3;
                @Attack3.performed -= m_Wrapper.m_SpielerbodenActionsCallbackInterface.OnAttack3;
                @Attack3.canceled -= m_Wrapper.m_SpielerbodenActionsCallbackInterface.OnAttack3;
                @Attack4.started -= m_Wrapper.m_SpielerbodenActionsCallbackInterface.OnAttack4;
                @Attack4.performed -= m_Wrapper.m_SpielerbodenActionsCallbackInterface.OnAttack4;
                @Attack4.canceled -= m_Wrapper.m_SpielerbodenActionsCallbackInterface.OnAttack4;
                @Weaponchange.started -= m_Wrapper.m_SpielerbodenActionsCallbackInterface.OnWeaponchange;
                @Weaponchange.performed -= m_Wrapper.m_SpielerbodenActionsCallbackInterface.OnWeaponchange;
                @Weaponchange.canceled -= m_Wrapper.m_SpielerbodenActionsCallbackInterface.OnWeaponchange;
                @Charchange.started -= m_Wrapper.m_SpielerbodenActionsCallbackInterface.OnCharchange;
                @Charchange.performed -= m_Wrapper.m_SpielerbodenActionsCallbackInterface.OnCharchange;
                @Charchange.canceled -= m_Wrapper.m_SpielerbodenActionsCallbackInterface.OnCharchange;
                @Dash.started -= m_Wrapper.m_SpielerbodenActionsCallbackInterface.OnDash;
                @Dash.performed -= m_Wrapper.m_SpielerbodenActionsCallbackInterface.OnDash;
                @Dash.canceled -= m_Wrapper.m_SpielerbodenActionsCallbackInterface.OnDash;
                @AimLook.started -= m_Wrapper.m_SpielerbodenActionsCallbackInterface.OnAimLook;
                @AimLook.performed -= m_Wrapper.m_SpielerbodenActionsCallbackInterface.OnAimLook;
                @AimLook.canceled -= m_Wrapper.m_SpielerbodenActionsCallbackInterface.OnAimLook;
                @Lockon.started -= m_Wrapper.m_SpielerbodenActionsCallbackInterface.OnLockon;
                @Lockon.performed -= m_Wrapper.m_SpielerbodenActionsCallbackInterface.OnLockon;
                @Lockon.canceled -= m_Wrapper.m_SpielerbodenActionsCallbackInterface.OnLockon;
                @Lockonchange.started -= m_Wrapper.m_SpielerbodenActionsCallbackInterface.OnLockonchange;
                @Lockonchange.performed -= m_Wrapper.m_SpielerbodenActionsCallbackInterface.OnLockonchange;
                @Lockonchange.canceled -= m_Wrapper.m_SpielerbodenActionsCallbackInterface.OnLockonchange;
                @Heal.started -= m_Wrapper.m_SpielerbodenActionsCallbackInterface.OnHeal;
                @Heal.performed -= m_Wrapper.m_SpielerbodenActionsCallbackInterface.OnHeal;
                @Heal.canceled -= m_Wrapper.m_SpielerbodenActionsCallbackInterface.OnHeal;
                @Ability1.started -= m_Wrapper.m_SpielerbodenActionsCallbackInterface.OnAbility1;
                @Ability1.performed -= m_Wrapper.m_SpielerbodenActionsCallbackInterface.OnAbility1;
                @Ability1.canceled -= m_Wrapper.m_SpielerbodenActionsCallbackInterface.OnAbility1;
                @Ability2.started -= m_Wrapper.m_SpielerbodenActionsCallbackInterface.OnAbility2;
                @Ability2.performed -= m_Wrapper.m_SpielerbodenActionsCallbackInterface.OnAbility2;
                @Ability2.canceled -= m_Wrapper.m_SpielerbodenActionsCallbackInterface.OnAbility2;
                @Ability3.started -= m_Wrapper.m_SpielerbodenActionsCallbackInterface.OnAbility3;
                @Ability3.performed -= m_Wrapper.m_SpielerbodenActionsCallbackInterface.OnAbility3;
                @Ability3.canceled -= m_Wrapper.m_SpielerbodenActionsCallbackInterface.OnAbility3;
                @Ability4.started -= m_Wrapper.m_SpielerbodenActionsCallbackInterface.OnAbility4;
                @Ability4.performed -= m_Wrapper.m_SpielerbodenActionsCallbackInterface.OnAbility4;
                @Ability4.canceled -= m_Wrapper.m_SpielerbodenActionsCallbackInterface.OnAbility4;
                @Ability56.started -= m_Wrapper.m_SpielerbodenActionsCallbackInterface.OnAbility56;
                @Ability56.performed -= m_Wrapper.m_SpielerbodenActionsCallbackInterface.OnAbility56;
                @Ability56.canceled -= m_Wrapper.m_SpielerbodenActionsCallbackInterface.OnAbility56;
                @Spezial.started -= m_Wrapper.m_SpielerbodenActionsCallbackInterface.OnSpezial;
                @Spezial.performed -= m_Wrapper.m_SpielerbodenActionsCallbackInterface.OnSpezial;
                @Spezial.canceled -= m_Wrapper.m_SpielerbodenActionsCallbackInterface.OnSpezial;
                @GButton.started -= m_Wrapper.m_SpielerbodenActionsCallbackInterface.OnGButton;
                @GButton.performed -= m_Wrapper.m_SpielerbodenActionsCallbackInterface.OnGButton;
                @GButton.canceled -= m_Wrapper.m_SpielerbodenActionsCallbackInterface.OnGButton;
                @Interaction.started -= m_Wrapper.m_SpielerbodenActionsCallbackInterface.OnInteraction;
                @Interaction.performed -= m_Wrapper.m_SpielerbodenActionsCallbackInterface.OnInteraction;
                @Interaction.canceled -= m_Wrapper.m_SpielerbodenActionsCallbackInterface.OnInteraction;
                @Openelemenu.started -= m_Wrapper.m_SpielerbodenActionsCallbackInterface.OnOpenelemenu;
                @Openelemenu.performed -= m_Wrapper.m_SpielerbodenActionsCallbackInterface.OnOpenelemenu;
                @Openelemenu.canceled -= m_Wrapper.m_SpielerbodenActionsCallbackInterface.OnOpenelemenu;
                @Openequipentmenu.started -= m_Wrapper.m_SpielerbodenActionsCallbackInterface.OnOpenequipentmenu;
                @Openequipentmenu.performed -= m_Wrapper.m_SpielerbodenActionsCallbackInterface.OnOpenequipentmenu;
                @Openequipentmenu.canceled -= m_Wrapper.m_SpielerbodenActionsCallbackInterface.OnOpenequipentmenu;
                @Test.started -= m_Wrapper.m_SpielerbodenActionsCallbackInterface.OnTest;
                @Test.performed -= m_Wrapper.m_SpielerbodenActionsCallbackInterface.OnTest;
                @Test.canceled -= m_Wrapper.m_SpielerbodenActionsCallbackInterface.OnTest;
            }
            m_Wrapper.m_SpielerbodenActionsCallbackInterface = instance;
            if (instance != null)
            {
                @Maus.started += instance.OnMaus;
                @Maus.performed += instance.OnMaus;
                @Maus.canceled += instance.OnMaus;
                @Laufen.started += instance.OnLaufen;
                @Laufen.performed += instance.OnLaufen;
                @Laufen.canceled += instance.OnLaufen;
                @Sprung.started += instance.OnSprung;
                @Sprung.performed += instance.OnSprung;
                @Sprung.canceled += instance.OnSprung;
    ...
    public SpielerbodenActions @Spielerboden => new SpielerbodenActions(this);
    ...
    public interface ISpielerbodenActions
    {
        void OnMaus(InputAction.CallbackContext context);
        void OnLaufen(InputAction.CallbackContext context);
        void OnSprung(InputAction.CallbackContext context);
