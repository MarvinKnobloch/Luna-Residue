...
public class Chooseshoes : MonoBehaviour, IPointerEnterHandler, IPointerExitHandler
{
    ...
    public void setshoes()
    {
        if (itemvalues != null)
        {
            ...
            Statics.charcurrentshoesname[currentint] = GetComponentInChildren<Text>().text;
