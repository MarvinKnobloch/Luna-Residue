...
public class Choosegloves : MonoBehaviour, IPointerEnterHandler, IPointerExitHandler
{
        ...
        public void setgloves()
    {
        if (itemvalues != null)
        {
            ...
            Statics.charcurrentglovesname[currentint] = GetComponentInChildren<Text>().text;
