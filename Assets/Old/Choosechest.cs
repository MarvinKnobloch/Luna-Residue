...
public class Choosechest : MonoBehaviour, IPointerEnterHandler, IPointerExitHandler
{
    ...
    public void setchest()
    {
        ...
        if (itemvalues != null)
        {
            ...
            Statics.charcurrentchestname[currentint] = GetComponentInChildren<Text>().text;
...
/*            if (Statics.mariacurrentchestimage != null)
            {
                Statics.mariacurrentchestimage.transform.GetChild(0).GetComponentInChildren<Image>().color = Color.white;
            }
            transform.GetChild(0).GetComponentInChildren<Image>().color = Color.green;
            Statics.mariacurrentchestimage = this.gameObject;
            Statics.activechestslot = this.gameObject;*/