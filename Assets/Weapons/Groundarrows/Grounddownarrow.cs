...
public class Grounddownarrow : MonoBehaviour
{
...
/*private void Checkhitboxbasic()
{
    if (Arrowtarget != null)
    {
        if (Arrowtarget.GetComponentInChildren<EnemyHP>())
        {
            if (Random.Range(0, 100) < overallcrit + Arrowtarget.gameObject.GetComponent<Enemydebuff>().enemycritdebuff)
            {
                Arrowtarget.gameObject.GetComponentInChildren<EnemyHP>().TakeDamage(overallbasiccritdmg);
                var showtext = Instantiate(damagetext, Arrowtarget.transform.position, Quaternion.identity);
            ...
            {
                Arrowtarget.gameObject.GetComponentInChildren<EnemyHP>().TakeDamage(basicdmgtodeal);
                var showtext = Instantiate(damagetext, Arrowtarget.transform.position, Quaternion.identity);
